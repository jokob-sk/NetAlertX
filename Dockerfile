...
RUN apt-get update \
    && apt-get install --no-install-recommends ca-certificates curl arp-scan perl apt-utils cron sudo lighttpd php php-cgi php-fpm php-sqlite3 sqlite3 dnsutils net-tools python iproute2 -y \
