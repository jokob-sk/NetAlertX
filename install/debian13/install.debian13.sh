...
# Update /install/start.debian13.sh in most cases is preferred 

echo "---------------------------------------------------------"
echo "[INSTALL] Starting NetAlertX installation for Debian13 (Trixie)"
echo "---------------------------------------------------------"
echo
echo "This script will install NetAlertX on your Debian 13 Trixie system."
